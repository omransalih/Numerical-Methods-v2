...
%% Example 1: Use Predictor Corrector Method (Euler & Trapz) to solve the initial value 
%  problem (Given h = 0.1)
...
y(1) = 1; %y_0
for i = 2:numel(t)
    p(i) = y(i-1) + h*f(t(i-1), y(i-1));
    y(i) = y(i-1) + (h/2)*(f(t(i-1), y(i-1)) + f(t(i), p(i)));
...
title('Graph of Predictor Corrector Method (Euler & Trapz)')
